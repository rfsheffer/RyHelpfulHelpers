...
enum class ERyShaderPlatform : uint8
{
	...
	SP_METAL_ES3_1_IOS UMETA(DisplayName="METAL ES3.1 IOS"),
	SP_METAL_SM5_IOS UMETA(DisplayName="METAL SM5 IOS"),
#endif
#if ENGINE_MAJOR_VERSION < 5 || (ENGINE_MAJOR_VERSION == 5 && ENGINE_MINOR_VERSION < 6)
...
#if ENGINE_MAJOR_VERSION > 5 || (ENGINE_MAJOR_VERSION == 5 && ENGINE_MINOR_VERSION >= 6)
	SP_VULKAN_SM6 UMETA(DisplayName="VULKAN SM6"),
	SP_METAL_SM6 UMETA(DisplayName="METAL SM6"),
	SP_METAL_SIM UMETA(DisplayName="METAL SIM"),
#endif
};
